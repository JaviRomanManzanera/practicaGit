...
public class VistaVer extends JFrame{
    public static final String ID_BOTON_SIGUIENTE = "Boton Siguiente Ver";
    public static final String ID_BOTON_ANTERIOR = "Boton Anterior Ver";
    ...
    private JButton buttonAnterior, buttonSiguiente;

    public VistaVer(ControladorVista controladorVista){
        super("Agenda");
    ...
    private void crearPanelTitulo2() {
        JLabel jLabelTitulo2 = new JLabel("Visualizar Contactos");
